...
import { toggleAddModal, pushPatient } from "./store";
...
const AddPatient = () => {
  const { openPatientModal } = useSelector((state) => state.patient);
